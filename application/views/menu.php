...
<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarTogglerDemo01" aria-controls="navbarTogglerDemo01" aria-expanded="false" aria-label="Toggle navigation">
  ...
  <div class="collapse navbar-collapse justify-content-end" id="navbarTogglerDemo01">
    ...
    <ul class="navbar-nav ">
      ...
      <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); 	?>dashboard/home">Profile</a>
      </li>
		<li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); ?>dashboard/class">My 	Class</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="<?php echo base_url(); 	?>dashboard/schedule">Schedule</a>
      </li>
