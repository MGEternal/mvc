					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							...
							<!-- <img class="nav-user-photo" src="<?php echo base_url(); ?>themes/smartadmin/img/box_icon2.png" alt="Box icon" height="150" width="150"/> -->
								...
								<h4 class="blue" id="id-company-text">&copy; SIMS</h4>
							</div>
							...
							<?php echo form_open("login/chklogin", array('id'=>'login-form'));?>
							<?php  	if ($this->session->flashdata('msg_error') != ''){ echo $this->session->flashdata('msg_error'); }  ?>
												<fieldset>
													...
													<div class="clearfix">
														...
														<a  href="<?php echo base_url();?>welcome" class="width-30  btn btn-sm btn-primary">
														
														Home
													
														</a>
														<a  href="<?php echo base_url();?>register" class="width-30  btn btn-sm btn-primary">
