...
?>
    ...
    <form action="<?php echo base_url(); ?>Admin_dashboard/profile" method="post">
    ...
    <select name="class_id" id="class_id" class="form-control"> 
        ...
        ?>
        <option value="<?php print_r ( $single_class['class_id'] ); ?>"    <?php if($single_user['class_id']==$single_class['class_id']) echo "selected"   ?>               >
